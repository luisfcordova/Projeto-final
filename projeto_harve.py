...
# Verifica se o pedido foi atrasado
...
# cria uma nova coluna para indicar se houve atraso
df_merge['delayed'] = df_merge['order_delivered_customer_date'] > df_merge['order_estimated_delivery_date']

### função para calcular clientes recorrentes por estado
...
### verifica se a media de clientes recorrentes é maior
...
### função para calcular a porcentagem de clientes recorrentes quando a entrega for atrasada.
